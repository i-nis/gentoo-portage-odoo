...
SRC_URI="http://nightly.odoo.com/7.0/nightly/src/openerp_${PV}.tar.gz"
LICENSE="AGPL-3"
SLOT="0"
KEYWORDS="x86 amd64"
...
src_unpack() {
	...
	mv ${WORKDIR}/openerp-${MY_PV} ${WORKDIR}/${P} || die "Install failed!"
}
